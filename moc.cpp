...
{
	static_cast<QmlBridge*>(ptr)->sendToQml(QString::fromUtf8(source.data, source.len), QString::fromUtf8(action.data, action.len), QString::fromUtf8(data.data, data.len));
}
